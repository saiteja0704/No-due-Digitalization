<!DOCTYPE html>
    <html>
        ...
        <nav class="navbar navbar-expand-lg navbar-light  bg-transparent border border-primary" >
            <a class="navbar-brand" style="font-size: 35px; font-family:Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif" >Mentor</a>
    ...
    <?php while ($row = mysqli_fetch_array($result)) 
            {
                ...
                $field5name = $row["id"];
                $field6name = $row["otp"];?>
                    <form method='POST' name="form" action='final.php'>
                        <tr>
                            ...
                            <td style='text-align:center'><?php echo "$field6name"; ?></td>
